...
//		if(test == null) test = "Campo GET ?test= veio nulo!";
		...
		model.addAttribute("balancoMes", serviceMovimentacao.getBalancoDoMes());
		model.addAttribute("balancoSemana", serviceMovimentacao.getBalancoDaSemana());
		...
		model.addAttribute("movimentacoesFiado", serviceMovimentacao.getMovimentacoesFiadoHoje());
  		model.addAttribute("categorias", serviceMovimentacao.getGastosCategoricamente());
